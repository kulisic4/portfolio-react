...
function Body(){
    ...
    <nav id="navtop">
      <text className="nav-text"
        >sdsd<a id="anchor" className="front">FRONT</a
        >jsdkasjhdkjsadhskjsdkksmskskkssdsdsjd<a id="anchor" className="developer"
          >DEVELOPER</a
        >jsdkddi ksdfhksjdfhksjdhjfsdasdashssl<a id="anchor" className="end">END</a
        >ksldkfjlskdfjlksdjflksalksdjlaksdjlj o<a id="anchor" className="DANILO"
          >DANILO</a
        >alksdjlasjsldjhvifsjdhsdhfksjpaodjhhdwefgqsislkdfnk<a
          id="anchor"
          className="kulisic"
          >KULISIC</a
    ...
    <nav className="nav-left">
      <ul className="ul-left">
        <a className="anchor-ab" href="#anchor-ab">
          <li className="about-li"><header className="left-menu">ABOUT</header></li></a
        >
    ...
    <section className="section2" id="anchor-proj">
      ...
      <p className="apple-text">
        Welcome to my first project ever! I was learning about HTML and CSS for
        about a month, and those are the results. With the help of my mentor
        <a className="projects-anchor" href="https://www.slavo.io/"
          >Slavoljub Popovic</a
        >, I made a great progress in a short period of time. With help of the
        right people and persistence you can improve your progress. Here is the
        video of fully functional Clone Apple Page I made, using only HTML and
        CSS. Here is also the link of the page so you can try it out yourself
        <a
